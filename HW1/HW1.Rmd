...
for(i in 1:length(airlines))
{
  ...
  plot(x=as.integer(plot_dat$Month),y=plot_dat$Baggage_perc,type="o",xaxt="n",xlab="", ylab="Baggage % ",lty=2, col=2, pch = 2,ylim = c(min(res$Baggage_perc),max(res$Baggage_perc)))
  axis(1,at = seq(1,12),labels = levels(res$Month))
